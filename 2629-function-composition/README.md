...
<pre style="position: relative;"><strong>Input:</strong> functions = [x =&gt; x + 1, x =&gt; x * x, x =&gt; 2 * x], x = 4
...
<pre style="position: relative;"><strong>Input:</strong> functions = [x =&gt; 10 * x, x =&gt; 10 * x, x =&gt; 10 * x], x = 1
...
<pre style="position: relative;"><strong>Input:</strong> functions = [], x = 42
<strong>Output:</strong> 42
<strong>Explanation:</strong>
The composition of zero functions is the identity function<div class="open_grepper_editor" title="Edit &amp; Save To Grepper"></div></pre>
