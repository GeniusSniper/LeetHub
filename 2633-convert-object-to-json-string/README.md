...
<pre style="position: relative;"><strong>Input:</strong> object = {"y":1,"x":2}
<strong>Output:</strong> {"y":1,"x":2}
<strong>Explanation:</strong> 
Return the JSON representation.
Note that the order of keys should be the same as the order returned by Object.keys().<div class="open_grepper_editor" title="Edit &amp; Save To Grepper"></div></pre>

<p><strong class="example">Example 2:</strong></p>

<pre style="position: relative;"><strong>Input:</strong> object = {"a":"str","b":-12,"c":true,"d":null}
...
<pre style="position: relative;"><strong>Input:</strong> object = {"key":{"a":1,"b":[{},null,"Hello"]}}
...
<pre style="position: relative;"><strong>Input:</strong> object = true
<strong>Output:</strong> true
<strong>Explanation:</strong>
Primitive types are valid inputs.<div class="open_grepper_editor" title="Edit &amp; Save To Grepper"></div></pre>
