...
<pre style="position: relative;"><strong>Input:</strong> func = () =&gt; checkIfInstanceOf(new Date(), Date)
...
<pre style="position: relative;"><strong>Input:</strong> func = () =&gt; { class Animal {}; class Dog extends Animal {}; return checkIfInstanceOf(new Dog(), Animal); }
<strong>Output:</strong> true
...
Dog is a subclass of Animal. Therefore, a Dog object is an instance of both Dog and Animal.<div class="open_grepper_editor" title="Edit &amp; Save To Grepper"></div></pre>

<p><strong class="example">Example 3:</strong></p>

<pre style="position: relative;"><strong>Input:</strong> func = () =&gt; checkIfInstanceOf(Date, Date)
...
<pre style="position: relative;"><strong>Input:</strong> func = () =&gt; checkIfInstanceOf(5, Number)
<strong>Output:</strong> true
