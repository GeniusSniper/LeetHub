...
<pre style="position: relative;"><strong>Input:</strong> nums = [[1,2],[3,4]], operation = "Add"
...
<pre style="position: relative;"><strong>Input:</strong> nums = [[23,98,42,70]], operation = "String"
...
<pre style="position: relative;"><strong>Input:</strong> nums = [[],[]], operation = "Add"
